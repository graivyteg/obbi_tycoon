...
namespace FIMSpace
{
    ...
    public partial class LeaningProcessor
    {
        ...
        [Range(0f, 1f)] [Tooltip("How quickly / slow the fade off all leaning animation blend should change")]
        ...
        internal void LateUpdate()
        {
            ...
            if (UpdateMode != AnimatorUpdateMode.Fixed) UpdateAngularVelocity();
