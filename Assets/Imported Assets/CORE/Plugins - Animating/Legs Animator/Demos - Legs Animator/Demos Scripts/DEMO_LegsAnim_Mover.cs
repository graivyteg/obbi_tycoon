...
namespace FIMSpace.FProceduralAnimation
{
    ...
    public class DEMO_LegsAnim_Mover : MonoYandex
    {
        ...
        void Update()
        {
            ...
            if (JoystickInput && JoystickInput.Direction != Vector2.zero)
            {
                moveDirectionLocal.x += JoystickInput.Direction.x;
                moveDirectionLocal.y += JoystickInput.Direction.y;
            }
